package com.sabu.openpgp.utils;
...
public class PgpHelperImpl {

    private static PgpHelperImpl INSTANCE = null;

    public static PgpHelperImpl getInstance(){

        if(INSTANCE == null) INSTANCE = new PgpHelperImpl();
        return INSTANCE;
    }

    private PgpHelperImpl(){}
